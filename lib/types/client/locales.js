...
export const zh = {
    'liquidGlass.title': '分级液态玻璃主题',
    'liquidGlass.description': '基于 VisionOS 多层光学架构：一层基底雾面玻璃 + 二层悬浮液态透镜 + 环境底板',
...
export const en = {
    'liquidGlass.title': 'Tiered Liquid Glass Theme',
    'liquidGlass.description': 'VisionOS-inspired multi-tier optics: Layer 1 Frosted Base Glass + Layer 2 Floating Liquid Lenses + Environment Substrate',
